...
public class FieldNoteSenderTest {
    ...
    public void testCreateDialog() throws Exception {
        ...
        EasyMock.expect(dialogHelper.createEditor(fieldNoteDialogView, "GC123 ", 0, resources))
                .andReturn(editText);
        PowerMock.expectNew(OnClickOk.class, resources, 0, editText, "GC123 ", context).andReturn(
                onClickOk);
        ...
        FieldNoteSender fieldNoteSender = new FieldNoteSender(layoutInflater, dialogBuilder,
                dialogHelper, resources);
        fieldNoteSender.createDialog("GC123", 0, context);
        PowerMock.verifyAll();
    }
    ...
    public void testOnClickOk() throws Exception {
        ...
        PowerMock.replayAll();
        new OnClickOk(resources, 0, editText, editable, context).onClick(dialog, 0);
        PowerMock.verifyAll();
    }
}

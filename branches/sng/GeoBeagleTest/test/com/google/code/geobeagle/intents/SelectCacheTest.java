...
public class SelectCacheTest extends TestCase {
    ...
    public void testStartIntent() {
        ...
        replay(location);
        new SelectCache(myLocationProvider, getCoordsToast, activityStarter, intentFromActionFactory,
                resourceProvider, R.string.geocaching_maps_url).startIntent();

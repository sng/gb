...
public class GeocacheListControllerTest {
    ...
    public void testOnMenuOpened() {
        ...
        PowerMock.replayAll();
        new GeocacheListController(null, null, filterNearestCaches, null, null).onMenuOpened(
                0, menu);
        PowerMock.verifyAll();
    }
    ...
    public void testOnResumeAndImport() {
        ...
        PowerMock.replayAll();
        new GeocacheListController(cacheListRefresh, null, null, menuActionSyncGpx, null)

...
public class GpsStatusWidgetTest {
    ...
    public void testFadeMeter() {
        ...
        PowerMock.replayAll();
        new MeterFader(null, time).paint();
    ...
    public void testFadeMeterLastDelay() {
        ...
        PowerMock.replayAll();
        final MeterFader meterFader = new MeterFader(null, time);
        meterFader.paint();
        meterFader.paint();
        // Log.d("GeoBeagle", "painting " + lastUpdateLag);
        PowerMock.verifyAll();
    ...
    public void testMeterWrapper_SetAccuracyAzimuth() {
        ...
        PowerMock.replayAll();
        final Meter meter = new Meter(meterBars, null, null);
    ...
    public void testPaint() {
        ...
        PowerMock.replayAll();
        new GpsStatusWidgetDelegate(null, null, null, meterFader, null, null, null).paint();
        PowerMock.verifyAll();
    }
    ...
    public void testUpdateGpsWidgetRunnable() {
        ...
        PowerMock.replayAll();
        new UpdateGpsWidgetRunnable(handler, null, meter, textLagUpdater, activityVisible).run();
        PowerMock.verifyAll();
    }
}

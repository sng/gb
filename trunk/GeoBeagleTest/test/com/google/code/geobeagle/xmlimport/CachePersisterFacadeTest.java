...
public class CachePersisterFacadeTest {
    ...
    public void testLine() throws IOException {
        ...
        PowerMock.replayAll();
        new CachePersisterFacade(null, null, mCacheDetailsWriter, null, null, null)
                .line("some data");
        PowerMock.verifyAll();
    }
    ...
    public void testStart() {
        ...
        PowerMock.replayAll();
        new CachePersisterFacade(mCacheTagWriter, fileFactory, null, null, null, 
                "/sdcard/GeoBeagle/data").start();
        PowerMock.verifyAll();
    }
    ...
    public void testSymbol() {
        ...
        PowerMock.replayAll();
        new CachePersisterFacade(mCacheTagWriter, null, null, null, null, null)
    ...
    public void testWpt() {
        ...
        PowerMock.replayAll();
        new CachePersisterFacade(mCacheTagWriter, null, mCacheDetailsWriter, null, null, null)
                .wpt("37", "122");
        PowerMock.verifyAll();
    }
